...
- [Software Maintenance Flywheel](software-maintenance-flywheel.md) — Walks an AI-operated dependency-maintenance process through governance, execution, evidence, failure classification, SOP improvement, deterministic capability improvement, validation, persistence, and reuse.
