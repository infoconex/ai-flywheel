...
The organization implements this process as an AI Flywheel so execution can produce evidence, reveal weaknesses, and improve the operating model used by later runs.
...
[Classify the weakness or opportunity as governance, deterministic capability, procedural guidance, AI reasoning, validation, or another persistent operating asset.]

### Adapt

[Describe the proposed improvement and its applicability boundaries.]

### Validate

[Describe representative, regression, negative, and boundary validation.]

### Persist

[Describe versioning, authorization, activation, traceability, and rollback.]

### Reuse

[Show a later execution retrieving and using the improvement.]
...
[Repeat Execute, Observe, Evaluate, Classify, Adapt, Validate, Persist, and Reuse.]
...
|---|---|
| **1. Human Authority** | [Evidence] |
| **2. AI Operation** | [Evidence] |
| **3. Runtime Responsibilities** | [Evidence] |
| **4. Persistent Operational Procedure** | [Evidence] |
| **5. Outcome Evidence** | [Evidence] |
| **6. Evaluation and Classification** | [Evidence] |
| **7. Improvement Routing** | [Evidence] |
| **8. Governance Enforcement** | [Evidence] |
| **9. Persistent Learning** | [Evidence] |
| **10. Compounding Reuse** | [Evidence] |

## What Compounded

| Cycle | Evidence Revealed | Persistent Improvement | Effect on Later Execution |
|---|---|---|---|
| **Cycle 1** | [Evidence] | [Improvement] | [Effect] |
| **Cycle 2** | [Evidence] | [Improvement] | [Effect] |
| **Cycle 3** | [Evidence] | [Improvement] | [Effect] |

Explain why the result represents compounding improvement rather than retrying, saving logs, or making a one-time change.
