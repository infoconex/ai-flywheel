...
The ideas that later became the AI Flywheel began taking shape through practical work with AI that could create code and other capabilities for its own use, follow persistent procedures, handle execution failures, preserve useful lessons, and improve future execution.

The early focus was on how the process should work, not what to call it: how to move from using AI to create tools for a human operator toward AI operating, evaluating, and improving the system that performs the work.
