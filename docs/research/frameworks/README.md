...
- [MOSS](moss.md) — Examines production-failure-driven source-level self-modification, candidate replay, human-gated promotion, health checks, and rollback.
...
- [Ralph](ralph.md) — Examines repeated autonomous coding-agent loops, persistent repository artifacts, deterministic backpressure, and human loop engineering.
- [Reflexion](reflexion.md) — Examines feedback-driven self-reflection and persistent linguistic memory used to improve future attempts without changing model weights.
