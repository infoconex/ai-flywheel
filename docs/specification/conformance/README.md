...
| [**6. Failure Determines Where the System Evolves**](../principles/06-evolution-routing.md) | Outcomes and learning opportunities are classified to determine whether adaptation is justified and where resulting learning should live. Successful outcomes may reinforce validated patterns without requiring change. | [Evaluate](../lifecycle/03-evaluate.md), [Classify](../lifecycle/04-classify.md), [Adapt](../lifecycle/05-adapt.md) |
