...
The AI performs the work using the current combination of procedural guidance, AI reasoning, and deterministic capability.

## Purpose

Execution applies the current operating system of the Flywheel to real work.

The AI is the operator of the process. It follows persistent procedural guidance, invokes deterministic capabilities, reasons about context and ambiguity, and carries authorized work forward without requiring a human to perform routine steps.
...
- and the current operating state inherited from earlier Flywheel cycles.

## Required Behavior

During execution:

- the AI must perform meaningful work rather than only generate instructions for a human operator,
- deterministic capability, procedural guidance, and AI reasoning must have clear and intentional roles,
...
- and other raw events needed to determine what actually happened.

These outputs become the main inputs to [Stage 2: Observe](02-observe.md).
...
When execution reaches the Uncertainty Boundary because there is not enough evidence for responsible judgment, the affected decision requires more evidence or human judgment.
...
Every meaningful execution should proceed to observation with enough data to evaluate the actual outcome.
...
- [Principle 1: Autonomy Is Bounded by Human Authority](../principles/01-human-authority.md) constrains every action.
...
- [Principle 3: Work Is Distributed Across a Moving Determinism Boundary](../principles/03-moving-determinism-boundary.md) defines how responsibility is divided during execution.
